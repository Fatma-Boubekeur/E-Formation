...
<form:form action="Passer_Quiz"   modelAttribute="cours_list"   class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-sm-9">
				<select  class="selectpicker" data-style="btn-white" data-live-search="true" name="q" >
				<c:forEach var="quiz" items="${quiz_list}">
				<option value="${quiz.id_quiz}" style="font-size: 22px;">
				${quiz.nom}
				</option>   
				</c:forEach>
				</select>
