        ...
        <div class="container" style=" width: auto;" id="id2">
            ...
            <div class="collapse navbar-collapse" id="main-nav" id="id5">
                <ul class="nav navbar-nav navbar-nav-margin-left">
                  ...
                  <li> <a href="CoursDisponibles"  style="font-size: 18px;font-family:'Playfair Display', serif;background-color:#cce6ff; ">Cours disponibles </a></li>
            ...
            <div class="col-xs-12 col-sm-4" style="margin-top:0px;margin-bottom: 50px;">
                <div class="card">
                          <a class="img-card" href="">
                            <img src="resources/CSS_JS/Template_CSS_JS/images/books-computer-wallpaper-49799-51477-hd-wallpapers.jpg" />
                          </a>
                            <div class="card-content">
                                <h4 class="card-title">
                                    <a href="#" style="font-size: 22px; margin-top:20px;">${cours.nom}
                                  </a>
                                </h4>
                              
                            </div>
                            <div class="card-read-more" style="padding-top: 20px;padding-bottom:20px;">
                                <a href="ActionRegisterCourse/${cours.id_cours}" style="font-size: 18px;">
                                   S'inscrire au cours
                                </a>
                            </div>
                </div>         
