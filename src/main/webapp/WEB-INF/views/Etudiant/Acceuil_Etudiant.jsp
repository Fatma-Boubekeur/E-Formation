...
<!-- Fixed navbar -->
        ...
        <div class="container" style=" width: auto;" id="id2">
            ...
            <div class="collapse navbar-collapse" id="main-nav" id="id5">
                <ul class="nav navbar-nav navbar-nav-margin-left">
                  <li> <a href="EspaceEtudiant"  style="font-size: 18px;font-family:'Playfair Display', serif; background-color:#cce6ff;">Home</a></li>
    ...
    <div class="parallax cover overlay cover-image-full home">
        <img class="parallax-layer" src="resources/CSS_JS/Template_CSS_JS/images/Etudiant.jpg" alt="Université alger 1 " />
