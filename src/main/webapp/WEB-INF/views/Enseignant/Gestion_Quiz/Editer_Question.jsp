...
<div class="col-md-6 col-lg-6 " style="background-color:;margin-bottom: 50px;margin-top: 0px;margin-left:80px;margin-top:0px;">            
	<h1  class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 30px; margin-left: 40px;margin-top:0px;">Editer Question Vrai / Faux </h1>
	<div class="panel panel-default" >
	    <div class="panel-body">

<!-- Begin Form  -->
    <form:form action="Action_Modifier_Question/${qst.id_qst}" modelAttribute="qst" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
	           ...
	           <div class="form-group">
                      ...
                      <form:textarea  path="contenue_qst" class="form-control" rows="2" cols="5" placeholder="Question..." style="font-size: 16px;font-family:'Playfair Display', serif;" name="question" id="question"/>
              ...
              <div class="form-group">
                      <label for="inputEmail3" class="col-sm-12 control-label" style="font-size: 20px;font-family:'Playfair Display', serif; text-align: left;margin-bottom: 20px;" >Veuillez saisir la note de la question </label>
                        <div class="col-sm-6" style="font-family:'Playfair Display', serif;">
                              <form:input path="note" type="number" max="20" min="0,5" class="form-control" style="font-size: 16px;" name="note"  id="note"/>               
                      </div>                       
              </div>
