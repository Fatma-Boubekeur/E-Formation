...
<h1 align="center" style="font-family: 'Playfair Display', serif; font-size: 30px;">Liste des quizs du cours <b>${nom_cours}</b> </h1>  
                <br />  
                     ...
                     <table id="table_question" class="table table-striped table-bordered mytable">  
                          <thead >  
                               <tr>  
                                    ...
                                    <th style="color: white; width: auto;">Type  </th> 
                                    <th style="color: white; width: auto;">Date création</th>
                                    <th style="color: white; width: auto;">Date limite</th>
                      ...
                      <tbody>
                        <c:forEach var="quiz" items="${list_quiz}">
                        <tr> 
                        ...
                        <a href="Listes_questions/${quiz.id_quiz}/${quiz.nom}" > 
                        <img src="resources/CSS_JS/Template_CSS_JS/images/office-work-information-help-task-company-question-query-list-clipboard-512.png" border="0" title="Listes des questions" style="width: 48px; height: 48px;"/>
                        </a>
                        
                        <!-- Liste des étudiants qui ont passé le quiz  -->
                        <a href="Listes_etudiants/${quiz.id_quiz}/${quiz.nom}" > 
                        <img src="resources/CSS_JS/Template_CSS_JS/images/student.png" border="0" title="Listes des étudiants du quiz" style="width: 48px; height: 48px;"/>
                        </a>
                         
                        <!-- Modifier Quiz -->
                        <a href="Modifier_Quiz/${quiz.id_quiz}" > 
                        <img src="resources/CSS_JS/Template_CSS_JS/images/education-fill-04-512.png" border="0" title="Editer le quiz" style="width: 48px; height: 48px;"/>
                        </a>
                         
                         
                        <!-- Supprimer Quiz -->
		                <a href="Supprimer_Quiz/${quiz.id_quiz}"
						onclick="return confirm('Etes-vous sûr de vouloir supprimer ce quiz?')"><img 
						src="resources/CSS_JS/Template_CSS_JS/images/delete-48.ico" border="0" title="Supprimer le quiz"/></a> 
