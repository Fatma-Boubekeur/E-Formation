...
<h1 class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 37px; margin-left: 40px;margin-top: 0px;">Editer quiz</h1>
     ...
     <div class="panel panel-default">
      ...
      <!--  Form begin     -->  
    <form:form action="Action_Modifier_Quiz/${quiz.id_quiz}" modelAttribute="quiz"  class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
