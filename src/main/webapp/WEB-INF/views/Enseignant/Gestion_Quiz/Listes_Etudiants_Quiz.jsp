...
<h1 align="center" style="font-family: 'Playfair Display', serif; font-size: 28px;">Liste des étudiants du quiz <b>${nom_quiz}</b></h1>  
                     ...
                     <table id="table_question" class="table table-striped table-bordered mytable">  
                          <thead >  
                               <tr>  
                                    ...
                                    <th style="color: white; width: auto;">Date passage quiz</th>
                                    <th style="color: white; width: auto;">Score</th>
                                    <th style="color: white; width: auto;">Actions</th>
                                                        
                               </tr>  
                          </thead>  
                      <tbody>
                        <c:forEach var="etud_quiz" items="${list_etud_quiz}">
                        <tr> 
                                      
                        <td style="text-align: center;"> 
                           ${etud_quiz.etudiant.getNom()}
                        </td> 
                        
                        
                        <td style="text-align: center;"> 
                           ${etud_quiz.etudiant.getPrenom()}
                        </td>
                        
                        <td style="text-align: center;"> 
                            
                        <script type="text/javascript">
						var date="${etud_quiz.date_passer_quiz}"
                        ...
                        <td style="text-align: center;"> 
                           ${etud_quiz.score_quiz}
                        </td>
                     
                       <!--  Listes des réponses d'un étudiants -->
                        <td style="text-align: center;">
                        <a href="Reponses_etudiants/${etud_quiz.etudiant.getId_etudiant()}/${nom_quiz}/${id_quiz}" > 
                        <button type="button" class="btn btn-primary btn-lg btn3d" style=" background-color:#1E90FF;border-color: #1E90FF font-size: 24px;text-align: center;font-family: Georgia, serif;" >Consulter réponses</button></a> 
                        </td> 
