     ...
     <h1  class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 30px; margin-left: 40px;">Ajouter Question à  Choix multiple </h1>
       <div class="panel panel-default" >
             <div class="panel-body">
               ...
               <!--  Begin Form -->     
                <form:form action="Listes_Questions_Choix_multiple/${id_quiz}" modelAttribute="qst"  class="form-horizontal" role="form" method="post"  enctype="multipart/form-data">
	                ...
	                <div class="form-group">
	                      <label for="inputEmail3" class="col-sm-12 control-label" style="font-size: 20px;font-family:'Playfair Display', serif; text-align: left;margin-bottom: 20px;" >Veuillez saisir le texte de la question </label>
		                        ...
		                        <form:textarea path="contenue_qst" class="form-control" rows="2" cols="5" placeholder="Question..." style="font-size: 15px;font-family:'Playfair Display', serif;font-size:20px;" name="question" id="question"/>
	                ...
	                <div class="form-group">
                         <label for="inputEmail3" class="col-sm-12 control-label" style="font-size: 20px;font-family:'Playfair Display', serif; text-align: left;margin-bottom: 20px;" >Veuillez saisir la note de la question </label>
                           <div class="col-sm-8" style="font-family:'Playfair Display', serif;">
                                 <form:input path="note" type="number" max="20" min="1" class="form-control"  name="note" style="font-size:20px;" id="note"/>     
	               ...
	               <!--  Réponses Choix Multiple -->
					...
					<div class="form-group">
					 <label for="inputEmail3" class="col-lg-12 control-label" style="font-size: 20px;font-family:'Playfair Display', serif;text-align: left;margin-bottom: 10px;margin-top: 20px; ">Veuillez créer la première réponse à la question</label></div>
             
                   <!-- Réponse 1 à la question  -->
		             <div class="form-group">
		     
                          <div class="col-sm-8" style="font-family:'Playfair Display', serif;font-size: 20px;">
                                  <input type="text" class="form-control" name="rep1"  id="rep1" style="font-family:'Playfair Display', serif;font-size:20px;">
					...
					<div class="form-group">
		             ...
		             <div class="form-group">   
                         ...
                         <div class="col-sm-8" style="font-family:'Playfair Display', serif;font-size: 20px;">
                          <input type="text" class="form-control" name="rep2" id="rep2" style="font-family:'Playfair Display', serif;font-size:20px;">
					...
					<div class="form-group">
                       ...
                       <div class="col-sm-8" style="font-family:'Playfair Display', serif;font-size: 20px;">
                               <input type="text" class="form-control"  name="rep3" id="rep3" style="font-family:'Playfair Display', serif;font-size:20px;">
