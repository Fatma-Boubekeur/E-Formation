...
<h1 align="center" style="font-family: 'Playfair Display', serif; font-size: 30px;">Liste des questions du quiz <b>${nom_quiz}</b></h1>  
                <br />  

            
                <div class="table-responsive" style="height:1000px;">  
                
			    <!--  Ajouter une nouvelle question au quiz (type Vrai Faux) -->
			    <a href="Ajouter_QST_Choix_Multiple" style="font-family:'Playfair Display', serif;font-size: 20px;color:black"> <b>
			    <img src="resources/CSS_JS/Template_CSS_JS/images/Question_Add.png" border="0"  title="Ajouter une nouvelle question" style="width: 60px; height: 60px;margin-bottom:5px;margin-top:0px;"/>
			    Ajouter question
			    </b></a>
                     ...
                     <table id="table_question" class="table table-striped table-bordered mytable">  
                      ...
                      <tbody>
                        <c:forEach var="qst" items="${list_qst_quiz}">
                        <tr> 
                        ...
                        <!-- Liste des réponses de la question  -->
                        <a href="Liste_Reponses_Qst/${qst.id_qst}" > 
                        <img src="resources/CSS_JS/Template_CSS_JS/images/answer.png" border="0" title="Listes des réponses" style="width: 48px; height: 48px;"/>
                        </a>
                         
                        <!-- Modifier Question -->
                        <a href="Modifier_Question/${qst.id_qst}" > 
                        <img src="resources/CSS_JS/Template_CSS_JS/images/help-edit-512.png" border="0" title="Editer la question" style="width: 48px; height: 48px;"/>
                        </a>
                         
                         
                        <!-- Supp Question -->
		                <a href="Supprimer_Question/${qst.id_qst}"
						onclick="return confirm('Etes-vous sûr de vouloir supprimer cette question?')"><img 
						src="resources/CSS_JS/Template_CSS_JS/images/delete-48.ico" border="0" title="Supprimer la question"/></a> 
