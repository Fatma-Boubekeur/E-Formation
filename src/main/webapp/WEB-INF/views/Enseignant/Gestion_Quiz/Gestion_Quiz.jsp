...
<div class="parallax cover overlay height-350" style="margin-top: 0px;margin-right: 30px; " >
        <img class="parallax-layer" data-auto-offset="true" data-auto-size="false" src="resources/CSS_JS/Template_CSS_JS/images/q.jpg" alt="Learning Cover">
