...
<div class="col-md-6 col-lg-6 " style="background-color:;margin-bottom: 50px;margin-top: 0px;margin-left:80px;margin-top:0px;">            
	<h1  class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 30px; margin-left: 40px;margin-top:0px;">Ajouter Question Vrai / Faux </h1>
	<div class="panel panel-default" >
	    <div class="panel-body">

<!-- Begin Form  -->
    <form:form action="Listes_Questions_Vrai_Faux/${id_quiz}" modelAttribute="qst" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
