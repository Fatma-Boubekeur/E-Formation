...
<h1 class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 37px; margin-left: 40px;margin-top: 0px;">Editer réponse</h1>
     ...
     <div class="panel panel-default">
      ...
      <!--  Form begin     -->  
    <form:form action="Action_Modifier_Reponse/${rep.id_reponse}" modelAttribute="rep"  class="form-horizontal" role="form" method="post" enctype="multipart/form-data">

       <!--  Reponse --> 
       
   
       <c:if test="${type_quiz=='Vrai ou Faux'}">
       <div class="form-group">
       <div class="col-sm-12" style="font-family:'Playfair Display', serif;">
              <input type="text" name="rep_contenue" value="${rep.rep_contenue}"  class="form-control" style="font-size: 20px;" style="font-family:'Playfair Display', serif;" readonly="readonly">     
       </div>              
       </div>
       </c:if>
       ...
       <c:if test="${type_quiz=='Choix multiple'}">
       <div class="form-group">
       <div class="col-sm-12" style="font-family:'Playfair Display', serif;">
              <input type="text" name="rep_contenue" value="${rep.rep_contenue}"  class="form-control" style="font-size: 20px;" style="font-family:'Playfair Display', serif;">     
       </div>              
       </div>
       </c:if>
        ...
        <!-- Iscorrecte -->
        <div class="form-group">
             <label for="inputEmail3" class="col-sm-4 control-label"  style="font-size: 24px;font-family:'Playfair Display', serif;text-align: left; ">Correcte ? </label>
             <div class="col-sm-6">
