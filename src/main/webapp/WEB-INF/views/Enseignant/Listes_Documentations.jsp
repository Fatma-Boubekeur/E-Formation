...
<h1 align="center" style="font-family: 'Playfair Display', serif; font-size: 40px;">Liste des documents</h1>  
                <br />  
                ...
                <div class="table-responsive">  
                     <table id="table_module" class="table table-striped table-bordered mytable">  
                      ...
                      <tbody>
                        ...
                        <!-- Save document -->
                        <a href="Save_Display/${doc.id_doc}" > 
                        <img src="resources/CSS_JS/Template_CSS_JS/images/icons8-save-all-48.png" border="0" title="Télécharger le document"/>
                        </a>
                         
                        <!-- Modifier document -->
                        <a href="Modifier_Document/${doc.id_doc}" > 
                        <img src="resources/CSS_JS/Template_CSS_JS/images/Edit-Document-icon.png" border="0" title="Editer le document" style="width: 48px; height: 48px;"/>
                        </a>
                         
                         
                        <!-- Supp document -->
		                <a href="Supprimer_Doc/${doc.id_doc}"
						onclick="return confirm('Etes-vous sûr de vouloir supprimer ce document?')"><img 
						src="resources/CSS_JS/Template_CSS_JS/images/delete-48.ico" border="0" title="Supprimer le document"/></a> 
