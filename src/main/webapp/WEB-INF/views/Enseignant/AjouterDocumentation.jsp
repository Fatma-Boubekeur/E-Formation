...
<div class="col-md-4" style="margin-top: 100px;">
                ...
                <div class="col-md-8 col-lg-8 " style="background-color: ;">            
                    <h1 class="page-section-heading" style="font-family:'Playfair Display', serif; text-align: center; font-size: 37px; margin-left: 40px;">Ajouter documentation</h1>
                    <div class="panel panel-default">
                    <div class="panel-body">
                    
      <!--  Form begin     -->               
      <form:form action="SaveDocument"   modelAttribute="Doc"  class="form-horizontal" role="form" method="post" enctype="multipart/form-data">


      <!--   choisir le cours   --> 
      <div class="form-group">
                       <label for="inputEmail3" class="col-sm-3 control-label"  style="font-size: 24px;font-family:'Playfair Display', serif;text-align: left; ">Cours</label>
                       <div class="col-sm-9">
